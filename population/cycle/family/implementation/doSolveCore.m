function doSolveCore( solutionResultsFilename,preyDiffusionCoeff,...
  secondPredatorDiffusionCoeff,resourceDeviation,N,tspan,...
  getInitialData,getFilename,getFileDirname,exists,loadVars,makeDir,...
  saveVars,getParams,solver )

[rightPartsOfEquations,~,~,nprey,npredator] = ...
...
[tsol,sol] = ...
    solver(rightPartsOfEquations,tspan,w0,...
