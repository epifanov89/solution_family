function predator_prey_2x1_nonuniform_resource_without_cosymmetry()
%PREDATOR_PREY_2x1_NONUNIFORM_RESOURCE_WITHOUT_COSYMMETRY Модель взаимодействия одной популяции
...
plot_phase_trajectories(solutions);
  ...
  function analyze_solution_and_output_results(t_arr,w)
    ...
    if isperiodic
      ...
      p = p+1;
      fprintf('\n');
      rho = multiplicators(@monodromy_matrix_one_system_for_each_column,...
