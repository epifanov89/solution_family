...
plot(wpredatormax(1,:),wpredatormax(2,:),familyLineSpec,...
...
maxSecondPredatorDensities = getLastRowWithExtremeElementValue(...
  ...
  maxExtremeValueKind);
l3 = plot(maxSecondPredatorDensities(firstPredatorCenterPointVarIndex),...
...
maxFirstPredatorDensities = getLastRowWithExtremeElementValue(...
  ...
  maxExtremeValueKind);
l4 = plot(maxFirstPredatorDensities(firstPredatorCenterPointVarIndex),...
