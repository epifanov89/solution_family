function isStopped = doSolveOneCore( solutionResultsFilename,...
  preyDiffusionCoeff,secondPredatorDiffusionCoeff,...
  firstPredatorMortality,resourceDeviation,N,tspan,getInitialData,...
  getFilename,getFileDirname,exists,loadVars,makeDir,saveVars,getParams,...
  solver )
