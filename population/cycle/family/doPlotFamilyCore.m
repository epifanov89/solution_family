...
%	DOPLOTFAMILYCORE »зображает графики двух семейств с установлени€ми из 
% двух начальных данных
%   Ќа графике вывод€тс€ максимальные плотности попул€ций хищников,
%   соединенные сплошной линией, и пунктиром установление из двух
%   начальных данных к разным режимам дл€ двух семейств
...
plotFam(@plotSteadyState);
  ...
  function plotFam(secondSolPlotFcn,XTick,YTick)
    ...
    % ¬ыбираем только файлы с результатами решений семейства
