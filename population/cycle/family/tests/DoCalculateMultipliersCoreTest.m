classdef DoCalculateMultipliersCoreTest < ...
  ...
  properties
    ...
    isGetResultsFilenameForMFileCalled
  ...
  methods
    ...
    function resultsFilename = fakeGetResultsFilenameForMFile(...
        testCase,filename,dirname)
      testCase.isGetResultsFilenameForMFileCalled = true;
      testCase.filenamePassedInToGetResultsFilenameForMFile = filename;
      testCase.dirnamePassedInToGetResultsFilenameForMFile = dirname;
      
      resultsFilename = testCase.monodromyMatrixFilename;
    end
  ...
  methods (Access = private)      
    ...
    function printed = isComputationTimePrinted(testCase)
      printed = contains(testCase.printedValsArray,...
  ...
  methods (Test)
    ...
    function testGetsIntermediateMonodromyMatrixFilename(testCase)
      testCase.setupZeroFirstPredatorSolutionToLoadForNEqualTo5();
      testCase.mfilename = 'filename';
      testCase.act();
      testCase.assertTrue(testCase.isGetResultsFilenameForMFileCalled,...
        'Не вызвана функция получения пути к файлу результатов, одноименному m-файлу');
      testCase.verifyEqual(...
        testCase.filenamePassedInToGetResultsFilenameForMFile,...
        testCase.mfilename,...
        'В функцию получения пути к файлу результатов, одноименному m-файлу, передан неправильный путь к m-файлу');
      testCase.verifyEqual(...
        testCase.dirnamePassedInToGetResultsFilenameForMFile,...
        'monodromy_matrix',...
    ...
    function testCalculateMultipliers(testCase)      
      ...
      testCase.monodromyMatrixFilename = 'monodromy_matrix.mat';
      ...
      testCase.verifyEqual(...
        testCase.monodromyMatrixFilenamePassedInToCalculateMultipliers,...
        testCase.monodromyMatrixFilename,...
    ...
    function testPrintsComputationTimeIfMultipliersComputed(testCase)
      ...
      testCase.act();
      testCase.verifyTrue(testCase.isComputationTimePrinted(),...
    ...
    function testDoesNotPrintComputationTimeIfMultipliersAreNotComputed(testCase)
      ...
      testCase.act();
      testCase.verifyFalse(testCase.isComputationTimePrinted(),...
    ...
    function testSavesVarsIfMultipliersAreComputed(testCase)
      ...
      argsInfo.vars = vars;
      testCase.verifyTrue(contains(testCase.argsPassedInToSaveArr,...
    ...
    function testDoesNotSaveVarsIfMultipliersAreNotComputed(testCase)
      ...
      testCase.act();
      testCase.verifyFalse(contains(testCase.argsPassedInToSaveArr,...
